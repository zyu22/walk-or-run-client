<template>
  ...
  >
    <div class="modal-container w-full max-w-3xl overflow-y-auto rounded-lg bg-white p-8">
      <!-- 로딩 상태 -->
      ...
      <div v-else>
        ...
        <header class="mb-8 flex items-center justify-between">
          <div>
            <h1 class="font-paperlogy text-4xl font-bold text-gray-900">챌린지 상세 정보</h1>
            <p class="mt-2 text-sm text-gray-600">챌린지 정보를 확인하세요!</p>
          </div>
          ...
          <div class="rounded-lg bg-white p-6 shadow-lg">
            <div class="grid grid-cols-1 gap-8">
              ...
              <div class="flex flex-col space-y-1">
                <label for="category" class="mb-2 block text-sm">챌린지 카테고리</label>
                <select
                  id="category"
                  v-model="challengeDetail.challengeCategoryName"
              ...
              <!-- 챌린지 제목 -->
              <div class="flex flex-col space-y-1">
                <label for="title" class="mb-2 block text-sm">챌린지 제목</label>
                <input
                  id="title"
              ...
              <!-- 챌린지 설명 -->
              <div class="flex flex-col space-y-1">
                <label for="description" class="mb-2 block text-sm">챌린지 설명</label>
                <textarea
                  id="description"
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <div class="rounded-lg bg-gray-50 p-4">
                  ...
                  <p class="text-lg font-semibold">
                    {{
                      (
                        (challengeDetail.challengeParticipantCnt /
                          challengeDetail.challengeTargetCnt) *
                        100
                      ).toFixed(1)
                    }}%
                  </p>
