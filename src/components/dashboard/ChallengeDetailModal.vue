  ...
  <Modal @close="$emit('close')">
    <div class="p-6">
      ...
      <div class="border-b pb-6">
        <h3 class="text-xl font-bold mb-4">{{ challenge.title }}</h3>
        <div class="mb-4">
          <span 
      ...
      <div class="py-4 border-b">
        <button class="w-full py-2 bg-[#ff6f3b] text-white rounded-lg hover:bg-[#ff825c] transition-colors">
          참여하기
        </button>
      </div>
      ...
      <div class="py-4 space-y-4">
        ...
        <div v-if="comments.length > 0" class="flex justify-center gap-2 pt-4">
          <button 
            ...
            :class="currentPage === page ? 'bg-[#ff6f3b] text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'"
          >
            {{ page }}
          </button>
        </div>
